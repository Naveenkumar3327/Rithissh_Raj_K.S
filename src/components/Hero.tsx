      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="bg-gray-900/90 backdrop-blur-xl rounded-lg border border-cyan-500/30 shadow-2xl mb-8 overflow-hidden">
          ...
          <div className="p-6 font-mono text-left">
            ...
            <div className="text-white mb-4">
              ...
              <span className="text-cyan-400">Status:</span> <span className="text-green-400">Available for opportunities</span>
            </div>
            ...
            <div className="text-cyan-400">$ ./start_portfolio.sh</div>
            <div className="text-green-400 animate-pulse">Portfolio initialized successfully! ✓</div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://github.com" className="group p-3 bg-gray-800/50 backdrop-blur-md rounded-lg border border-cyan-500/30 hover:bg-gray-700/50 transition-all duration-300 hover:scale-110">
              <Github size={24} className="text-gray-400 group-hover:text-cyan-400 transition-colors duration-300" />
            </a>
            <a href="https://linkedin.com" className="group p-3 bg-gray-800/50 backdrop-blur-md rounded-lg border border-cyan-500/30 hover:bg-gray-700/50 transition-all duration-300 hover:scale-110">
